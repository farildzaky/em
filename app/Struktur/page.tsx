...
const Struktur = () => {
  ...
  const kiri4X = useTransform(scrollY, [0, 5300], [-500, 0]);
  const kiri4Y = useTransform(scrollY, [0, 5300], [500, 0]);
    ...
    <div className="w-full ">
      ...
      <div className="font-helvetica bg-white pb-20 ">
        <motion.div
          ...
          style={{ x: motifKiriX }}
          className="absolute md:top-0 top-10 left-0 z-10 w-[10%] aspect-auto"
        >
          <Image
            src={motifkiri}
            alt="motif kiri"
        ...
        <motion.div
          ...
          transition={{ delay: 0.3, duration: 0.7, ease: "easeOut" }}
          style={{ x: motifKananX }}
          className="absolute md:top-0 right-0 top-10  z-10 w-[10%] aspect-auto"
        >
          <Image
            src={motifkanan}
            alt="motif kanan"
        ...
        <section className="container mx-auto lg:px-24 py-5">
          <div className="flex justify-center items-center gap-5">
            ...
            >
              <Image src={eyes2} alt="eyes" loading="lazy" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="container mx-auto lg:px-24 py-5">
          <div className="flex justify-center items-center gap-5">
            ...
            >
              <Image src={featherb} alt="feather" loading="lazy" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="container mx-auto lg:px-24 px-4 py-5 justify-center flex lg:flex-nowrap flex-wrap gap-1 overflow-hidden">
          <motion.div
            style={{ x: kiri3X, y: kiri3Y, opacity: opakiri3 }}
            className="lg:w-[18%] md:[32%] w-[45%] group"
          >
            <div className="w-full aspect-[9/15] group-hover:-translate-y-2 duration-300 ease-in-out relative">
              <Image
          ...
          <motion.div
            style={{ x: kanan3X, y: kanan3Y, opacity: opakanan3 }}
            className="lg:w-[18%] md:[32%] w-[45%] group"
          >
            <div className="w-full aspect-[9/15] group-hover:-translate-y-2 duration-300 ease-in-out relative">
              <Image
        ...
        <section className="container mx-auto lg:px-24 py-5">
          <div className="flex justify-center items-center gap-5">
            <motion.div
              style={{ x: kiri4X, y: kiri4Y }}
              className="w-1/2 font-helvetica font-helveticaExtraBold text-xl lg:text-4xl transform: translate-y-0 translate-z-0"
            >
            ...
            <motion.div
              style={{ x: kanan4X, y: kanan4Y }}
              className="w-1/6 object-contain aspect-square rounded-lg transform transform-x-0 transform-z-0"
            >
              <Image src={tradeb} alt="trade" loading="lazy" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="container mx-auto lg:px-24 px-4 py-5 justify-center flex lg:flex-nowrap flex-wrap gap-1 overflow-hidden">
          <motion.div
            style={{ x: kiri4X, y: kiri4Y, opacity: opakiri4 }}
            className="lg:w-[18%] md:[32%] w-[45%] group"
          >
            <div className="w-full aspect-[9/15] group-hover:-translate-y-2 duration-300 ease-in-out relative">
              <Image
          ...
          <motion.div
            style={{ x: kanan4X, y: kanan4Y, opacity: opakanan4 }}
            className="lg:w-[18%] md:[32%] w-[45%] group"
          >
            <div className="w-full aspect-[9/15] group-hover:-translate-y-2 duration-300 ease-in-out relative">
              <Image
